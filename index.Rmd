...
Ein herzliches Willkommen zu dieser Einführung in die politikwissenschaftlichen
Statistik mit `R`! 
...
[(1)	Sitzung: Einführung und Grundlagen](R_1.html)
[(2)	Sitzung: Faktoren und Objekte](R_2.html)
[(3)	Sitzung: Datensätze einladen und Variablen umkodieren](R_3.html)
[(4)	Sitzung: Univariate Analyse](R_4.html)
[(5)	Sitzung: Visualisierung univariater Verteilungen](R_5.html)
[(6)	Sitzung: Bivariate Analyse](R_6.html)
[(7)	Sitzung: Bivariate lineare Regression und Visualisierung](R_7.html)
[(8)	Sitzung: Multiple lineare Regression und Visualisierung](R_8.html)
[(9)	Sitzung: Anwendungsvoraussetzungen der linearen Regression](R_9.html)
[(10)	Sitzung: Binominale logistische Regression und Visualisierung](R_10.html)
[(11)	Sitzung: Zähldaten](R_11.html)
[(12)	Sitzung: Dimensionsreduzierende Verfahren](R_12.html)
...
GLES (2019). Nachwahl-Querschnitt (GLES 2017). GESIS Datenarchiv, Köln. ZA6801 Datenfile Version 4.0.1, https://doi.org/10.4232/1.13235 [Titel anhand dieser DOI in Citavi-Projekt übernehmen] .
